...
if ( sdim == 3 )  %%% TETRAHEDRA
      ...
      elseif ( quadorder == 2 ) 
        ...
        quadpoint(1,:) = [ 0.16666666666666667, 0.16666666666666667 ];
        quadpoint(2,:) = [ 0.66666666666666667, 0.16666666666666667 ];
        quadpoint(3,:) = [ 0.16666666666666667, 0.66666666666666667 ]; 
        
        quadweight(1) = 0.333333333333333333333; 
        quadweight(2) = 0.333333333333333333333; 
        quadweight(3) = 0.333333333333333333333;   
