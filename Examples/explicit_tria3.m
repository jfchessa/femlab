...
% explicit2d_tria3.m
%
% A two dimensional explicit finite element code.  This code is limited
% to small deformation linear elastic behavior.
%
...
%
fprintf('\n\n-----------------------------------------------\n');
fprintf('|      2D EXPLICIT FINITE ELEMENT CODE        |\n');
fprintf('-----------------------------------------------\n');
